                ...
                <form action="{{ route('contract.store') }}" method="POST" class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="date" id="start_date" name="start_date" class="mt-2 p-2 border border-gray-300 rounded-md w-full focus:outline-none focus:ring-2 focus:ring-blue-500" required>
                        </div>
                        <div>
                            <label for="end_date" class="block text-gray-700 font-semibold">Date de fin du contrat :</label>
                            <input type="date" id="end_date" name="end_date" class="mt-2 p-2 border border-gray-300 rounded-md w-full focus:outline-none focus:ring-2 focus:ring-blue-500" required>
                        </div>
                        <div>
                            <label for="tenant_id" class="block text-gray-700 font-semibold">Locataire :</label>
                            <select name="tenant_id" id="tenant_id" class="mt-2 p-2 border border-gray-300 rounded-md w-full focus:outline-none focus:ring-2 focus:ring-blue-500" required>
                        ...
                        <div>
                            ...
                            <select name="box_id" id="box_id" class="mt-2 p-2 border border-gray-300 rounded-md w-full focus:outline-none focus:ring-2 focus:ring-blue-500" required onchange="updatePrice()">
                        ...
                        <div>
                            ...
                            <input type="number" id="monthly_price" name="monthly_price" class="mt-2 p-2 border border-gray-300 rounded-md w-full focus:outline-none focus:ring-2 focus:ring-blue-500" required>
                        </div>
                        <div>
                            ...
                            <select name="model_contract_id" id="model_contract_id" class="mt-2 p-2 border border-gray-300 rounded-md w-full focus:outline-none focus:ring-2 focus:ring-blue-500" required onchange="updatePrice()">
                                <option value="">-- Sélectionner un modèle de contrat --</option>
